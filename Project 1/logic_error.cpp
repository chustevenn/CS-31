...
int main()
{
    ...
    if (pctGenX > pctGenY || pctGenX > pctGenZ) //introducing the 'or' operator rather than the 'and' operator will cause incorrect conclusions, but will not prevent the program from building.
    {
